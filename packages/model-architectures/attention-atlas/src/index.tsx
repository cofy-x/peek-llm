...
export function AttentionAtlasExperience() {
  ...
  return <div className={`attention-atlas ${node ? "attention-atlas--opened" : ""}`} ref={root}>
    <header className="atlas-header">
      <div className="atlas-title"><span className="atlas-edition">MODEL ARCHITECTURES / 01</span><h1>Attention <em>Atlas</em><span className="atlas-title-dot">.</span></h1></div>

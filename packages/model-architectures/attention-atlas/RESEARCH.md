...
The [paper-download guide](docs/README.md) and [pinned manifest](docs/papers.json) reproduce the research baseline in the Git-ignored `papers/` directory. They are research references, not bundled assets. Scene geometry and explanations are authored for this experience; no paper figure or reference-site asset is redistributed.
